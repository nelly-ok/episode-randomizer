...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_footer_donate_footer_donate_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/footer-donate/footer-donate.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_components_header_header_component__WEBPACK_IMPORTED_MODULE_1__["HeaderComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_2__["HomeComponent"], _components_footer_donate_footer_donate_component__WEBPACK_IMPORTED_MODULE_3__["FooterDonateComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_footer_donate_footer_donate_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./components/footer-donate/footer-donate.component */
    "./src/app/components/footer-donate/footer-donate.component.ts");
    /* harmony import */
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"], _components_footer_donate_footer_donate_component__WEBPACK_IMPORTED_MODULE_5__["FooterDonateComponent"], _components_header_header_component__WEBPACK_IMPORTED_MODULE_6__["HeaderComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppComponentsFooterDonateFooterDonateComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FooterDonateComponent", function () {
      return FooterDonateComponent;
    });
    /* harmony import */
    ...
    var FooterDonateComponent = /*#__PURE__*/function () {
      function FooterDonateComponent() {
        _classCallCheck(this, FooterDonateComponent);
      }

      _createClass(FooterDonateComponent, [{
        key: "ngOnInit",
    ...
    FooterDonateComponent.ɵfac = function FooterDonateComponent_Factory(t) {
      return new (t || FooterDonateComponent)();
    };

    FooterDonateComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: FooterDonateComponent,
      selectors: [["app-footer-donate"]],
      decls: 11,
      vars: 0,
      consts: [["id", "Footer", 1, "d-flex", "f-col", "align-center", "footer"], ["target", "_blank", "href", "https://cash.app/$yngdevnation"], ["type", "button", "name", "button", 1, "btn", "btn-primary", "random-btn", "donate-btn"], ["action", "https://formspree.io/mqkywbdz", "method", "post", 1, "email"], ["name", "email", "type", "email", "value", "", "placeholder", "Email..."]],
      template: function FooterDonateComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FooterDonateComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  function srcAppComponentsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 0,
      consts: [[1, "d-flex", "f-row", "just-space-between"], [1, "brand"], ["target", "_blank", "href", "https://cash.app/$yngdevnation"], ["type", "button", "name", "button", 1, "btn", "btn-primary", "random-btn", "donate-btn"]],
  ...
  function srcAppComponentsHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomeComponent = /*#__PURE__*/function () {
      ...
      _createClass(HomeComponent, [{
        ...
        key: "randomSeason",
        value: function randomSeason() {
          var lower = document.getElementById('SL').value;
          var upper = document.getElementById('SU').value;
          var res = Math.floor(Math.random() * +upper) + +lower;
          console.log(res);
          document.getElementById('SC').innerHTML = String(res);
        }
      }, {
        key: "randomEpisode",
        value: function randomEpisode() {
          var lower = document.getElementById('EL').value;
          var upper = document.getElementById('EU').value;
          var res = Math.floor(Math.random() * +upper) + +lower;
          console.log(res);
        ...
        key: "randomSeries",
        value: function randomSeries() {
          var loSeries = document.querySelectorAll('.series-option');
          var loStrings = []; // console.log(loSeries)

          for (var _i = 0; _i < loSeries.length; _i++) {
            loStrings.push(loSeries[_i].innerHTML);
          } // console.log(loStrings);


          var i = Math.floor(Math.random() * loSeries.length);
          var res = loStrings[i];
          document.getElementById('SEC').innerHTML = String(res);
          console.log("pleaase work");
          var sl = document.getElementById('SL').value;
          document.getElementById('SU').value = this.shows[i].season.toString(); //console.log("sl is", su)
          //su = this.shows[i].season.toString();
          //console.log("sl is after", su)

          var el = document.getElementById('EL').value;
          document.getElementById('EU').value = this.shows[i].episodes.toString(); // eu = this.shows[i].episodes.toString();
        }
      }, {
        key: "randomAll",
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 33,
      vars: 1,
      consts: [[1, "container", "d-flex", "f-row", "home", "blue"], [1, "series", "home-third", "d-flex", "f-col", "align-center"], ["id", "EpisodeSelect", "name", "", 1, ""], ["ng-click", "switch(show.id);", "class", "series-option", 3, "value", 4, "ngFor", "ngForOf"], ["type", "button", "name", "button", 1, "btn", "btn-primary", "random-btn", "red-bg", 3, "click"], ["id", "SEC", 1, "choice"], [1, "season", "home-third", "d-flex", "f-col", "align-center"], [1, "bounds", "d-flex", "f-row"], ["type", "text", "id", "SL", "name", "", "value", "1", 1, "lower-bound", "random-input"], ["type", "text", "id", "SU", "name", "", "value", "6", 1, "upper-bound", "random-input"], ["type", "button", "name", "button", 1, "btn", "btn-primary", "blue", "random-btn", "yellow-bg", 3, "click"], ["id", "SC", 1, "choice"], [1, "episode", "home-third", "d-flex", "f-col", "align-center"], ["type", "text", "id", "EL", "name", "", "value", "1", 1, "lower-bound", "random-input"], ["type", "text", "id", "EU", "name", "", "value", "16", 1, "upper-bound", "random-input"], ["type", "button", "name", "button", 1, "btn", "btn-primary", "blue", "random-btn", "green-bg", 3, "click"], ["id", "EC", 1, "choice"], ["type", "button", "name", "button", 1, "btn", "btn-primary", "random-btn", "green-bg", "random-all", 3, "click"], ["ng-click", "switch(show.id);", 1, "series-option", 3, "value"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/nelly/Dropbox-nelly/coding/web-dev/episode-randomizer/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
